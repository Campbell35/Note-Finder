...
const setupSelectedInstrumentSelector = document.querySelector('#instrument-selector');
...
const app = {
    ...
    setupFretboard() {
        ...
        for (let i = 0; i < numberOfStrings; i++) {
            ...
            for (let fret = 0; fret <= numberOfFrets; fret++) {
                ...
                let noteName = this.generateNoteName((fret + instrumentTuningPresets[selectedInstrument][i]), accidentals);
    ...
    setupSelectedInstrumentSelector() {
        for (instrument in instrumentTuningPresets) {
            ...
            setupSelectedInstrumentSelector.appendChild(instrumentOption);
        }
    ...
    setupEventListeners() {
        ...
        setupSelectedInstrumentSelector.addEventListener('change', () => {
